...
public class Jeu {
    ...
    public void distributionCartes() {
        ...
        // Ajoute les cartes dans la main du joueur 1
        for (int i = 0; i < nbCartesParJoueur; i++) {
            Carte carte = pioche.get(random.nextInt(pioche.size()));
    ...
    // Affiche les cartes dans la main d'un joueur
     ...
     * @return true si le j2 possède cette carte ou non
     */
...
/*
    ...
    public void tour(Joueur j){
        ...
        while (rejoue) {
            ...
            // le j1 rejoue si le j2 avait bien la carte voulue
